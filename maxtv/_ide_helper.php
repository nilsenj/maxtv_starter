...
namespace {
    ...
    class Access extends \Core\Access\AccessFacade{
        ...
        public static function hasRole($role, $requireAll = false){
            return \Core\Access\Access::hasRole($role, $requireAll);
        }
        ...
        public static function can($permission, $requireAll = false){
            return \Core\Access\Access::can($permission, $requireAll);
        }
         ...
         */
        public static function user(){
            return \Core\Access\Access::user();
        }
        ...
        public static function routeNeedsRole($route, $roles, $result = null, $requireAll = true){
            return \Core\Access\Access::routeNeedsRole($route, $roles, $result, $requireAll);
        }
        ...
        public static function routeNeedsPermission($route, $permissions, $result = null, $requireAll = true){
            return \Core\Access\Access::routeNeedsPermission($route, $permissions, $result, $requireAll);
        }
        ...
        public static function routeNeedsRoleOrPermission($route, $roles, $permissions, $result = null, $requireAll = false){
            \Core\Access\Access::routeNeedsRoleOrPermission($route, $roles, $permissions, $result, $requireAll);
        }
        
    }


    class Flash extends \Core\Components\Flash\Flash{
        ...
        public static function info($message){
            return \Core\Components\Flash\FlashNotifier::info($message);
        }
        ...
        public static function success($message){
            return \Core\Components\Flash\FlashNotifier::success($message);
        }
        ...
        public static function error($message){
            return \Core\Components\Flash\FlashNotifier::error($message);
        }
        ...
        public static function warning($message){
            return \Core\Components\Flash\FlashNotifier::warning($message);
        }
        ...
        public static function overlay($message, $title = 'Notice'){
            return \Core\Components\Flash\FlashNotifier::overlay($message, $title);
        }
        ...
        public static function message($message, $level = 'info'){
            return \Core\Components\Flash\FlashNotifier::message($message, $level);
        }
        ...
        public static function important(){
            return \Core\Components\Flash\FlashNotifier::important();
        }
